...
function Navbar() {
  ...
  const linkStyle = (active) => ({
    ...
    fontSize: "14px", fontWeight: active ? "600" : "400", fontFamily: font,
    ...
    <nav style={{
      ...
      {!isMobile && (
        <div style={{ display: "flex", gap: "4px", alignItems: "center" }}>
          ...
          <button onClick={toggleTheme} style={{ background: "rgba(124,58,237,0.12)", border: "1px solid rgba(124,58,237,0.2)", color: "#a78bfa", padding: "8px 14px", borderRadius: "20px", cursor: "pointer", fontSize: "13px", fontWeight: "500", fontFamily: font, display: "flex", alignItems: "center", gap: "6px", marginLeft: "8px" }}>
